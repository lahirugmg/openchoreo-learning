...
- First contribution target:
  - Fix outdated commands in `docs/contributors/contribute.md` in the main OpenChoreo repo.
- Second contribution target:
  - Submit one small Controller/API bug fix or test improvement.
